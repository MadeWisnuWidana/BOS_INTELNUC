...
{
public:
  explicit Init_GetParameters_Event_response(::op3_camera_setting_tool_msgs::srv::GetParameters_Event & msg)
  : msg_(msg)
  {}
  ::op3_camera_setting_tool_msgs::srv::GetParameters_Event response(::op3_camera_setting_tool_msgs::srv::GetParameters_Event::_response_type arg)
  {
...
private:
  ::op3_camera_setting_tool_msgs::srv::GetParameters_Event msg_;
};

class Init_GetParameters_Event_request
{
public:
  explicit Init_GetParameters_Event_request(::op3_camera_setting_tool_msgs::srv::GetParameters_Event & msg)
  : msg_(msg)
  {}
  Init_GetParameters_Event_response request(::op3_camera_setting_tool_msgs::srv::GetParameters_Event::_request_type arg)
  {
...
public:
  ...
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_GetParameters_Event_request info(::op3_camera_setting_tool_msgs::srv::GetParameters_Event::_info_type arg)
  {
...
template<>
inline
auto build<::op3_camera_setting_tool_msgs::srv::GetParameters_Event>()
{
  return op3_camera_setting_tool_msgs::srv::builder::Init_GetParameters_Event_info();
}
