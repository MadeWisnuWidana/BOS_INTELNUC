...
static const _GetParameters_Event_type_support_symbol_names_t _GetParameters_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, op3_camera_setting_tool_msgs, srv, GetParameters_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, op3_camera_setting_tool_msgs, srv, GetParameters_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, op3_camera_setting_tool_msgs, srv, GetParameters_Event)() {
  return &::op3_camera_setting_tool_msgs::srv::rosidl_typesupport_c::GetParameters_Event_message_type_support_handle;
}
