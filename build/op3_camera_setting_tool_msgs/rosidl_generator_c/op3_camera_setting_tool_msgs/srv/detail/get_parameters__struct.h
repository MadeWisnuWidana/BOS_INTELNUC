...
enum
{
  op3_camera_setting_tool_msgs__srv__GetParameters_Event__request__MAX_SIZE = 1
};
// response
enum
{
  op3_camera_setting_tool_msgs__srv__GetParameters_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/GetParameters in the package op3_camera_setting_tool_msgs.
typedef struct op3_camera_setting_tool_msgs__srv__GetParameters_Event
{
  service_msgs__msg__ServiceEventInfo info;
  op3_camera_setting_tool_msgs__srv__GetParameters_Request__Sequence request;
  op3_camera_setting_tool_msgs__srv__GetParameters_Response__Sequence response;
} op3_camera_setting_tool_msgs__srv__GetParameters_Event;

// Struct for a sequence of op3_camera_setting_tool_msgs__srv__GetParameters_Event.
typedef struct op3_camera_setting_tool_msgs__srv__GetParameters_Event__Sequence
{
