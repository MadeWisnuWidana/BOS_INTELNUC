  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const op3_camera_setting_tool_msgs__msg__V4lParameter * ros_message = static_cast<const op3_camera_setting_tool_msgs__msg__V4lParameter *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_op3_camera_setting_tool_msgs__msg__V4lParameter(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  op3_camera_setting_tool_msgs__msg__V4lParameter * ros_message = static_cast<op3_camera_setting_tool_msgs__msg__V4lParameter *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_op3_camera_setting_tool_msgs__msg__V4lParameter(cdr, ros_message);
}
