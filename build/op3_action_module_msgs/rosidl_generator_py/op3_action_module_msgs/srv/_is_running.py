...
class Metaclass_IsRunning_Event(type):
    """Metaclass of message 'IsRunning_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__is_running__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__is_running__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__is_running__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__is_running__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__is_running__event
...
class IsRunning_Event(metaclass=Metaclass_IsRunning_Event):
    """Message class 'IsRunning_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<op3_action_module_msgs/IsRunning_Request, 1>',
        'response': 'sequence<op3_action_module_msgs/IsRunning_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['op3_action_module_msgs', 'srv'], 'IsRunning_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['op3_action_module_msgs', 'srv'], 'IsRunning_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from op3_action_module_msgs.srv import IsRunning_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, IsRunning_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'IsRunning_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from op3_action_module_msgs.srv import IsRunning_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, IsRunning_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'IsRunning_Response'"
...
class Metaclass_IsRunning(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _is_running.Metaclass_IsRunning_Event._TYPE_SUPPORT is None:
                _is_running.Metaclass_IsRunning_Event.__import_type_support__()
...
class IsRunning(metaclass=Metaclass_IsRunning):
    ...
    from op3_action_module_msgs.srv._is_running import IsRunning_Event as Event
