  ...
  op3_online_walking_module_msgs__msg__JointPose * ros_message)
{
  ...
  // Field name: pose
  {
    cdr_deserialize_sensor_msgs__msg__JointState(cdr, &ros_message->pose);
  }
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const op3_online_walking_module_msgs__msg__JointPose * ros_message = static_cast<const op3_online_walking_module_msgs__msg__JointPose *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_op3_online_walking_module_msgs__msg__JointPose(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  op3_online_walking_module_msgs__msg__JointPose * ros_message = static_cast<op3_online_walking_module_msgs__msg__JointPose *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_op3_online_walking_module_msgs__msg__JointPose(cdr, ros_message);
}
