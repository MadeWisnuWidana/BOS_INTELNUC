...
class Metaclass_GetPreviewMatrix_Event(type):
    """Metaclass of message 'GetPreviewMatrix_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__get_preview_matrix__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__get_preview_matrix__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__get_preview_matrix__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__get_preview_matrix__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__get_preview_matrix__event
...
class GetPreviewMatrix_Event(metaclass=Metaclass_GetPreviewMatrix_Event):
    """Message class 'GetPreviewMatrix_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<op3_online_walking_module_msgs/GetPreviewMatrix_Request, 1>',
        'response': 'sequence<op3_online_walking_module_msgs/GetPreviewMatrix_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['op3_online_walking_module_msgs', 'srv'], 'GetPreviewMatrix_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['op3_online_walking_module_msgs', 'srv'], 'GetPreviewMatrix_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from op3_online_walking_module_msgs.srv import GetPreviewMatrix_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, GetPreviewMatrix_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'GetPreviewMatrix_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from op3_online_walking_module_msgs.srv import GetPreviewMatrix_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, GetPreviewMatrix_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'GetPreviewMatrix_Response'"
...
class Metaclass_GetPreviewMatrix(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _get_preview_matrix.Metaclass_GetPreviewMatrix_Event._TYPE_SUPPORT is None:
                _get_preview_matrix.Metaclass_GetPreviewMatrix_Event.__import_type_support__()
...
class GetPreviewMatrix(metaclass=Metaclass_GetPreviewMatrix):
    ...
    from op3_online_walking_module_msgs.srv._get_preview_matrix import GetPreviewMatrix_Event as Event
