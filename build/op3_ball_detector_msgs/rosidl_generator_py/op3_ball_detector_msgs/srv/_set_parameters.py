...
class SetParameters_Event(metaclass=Metaclass_SetParameters_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<op3_ball_detector_msgs/SetParameters_Request, 1>',
        'response': 'sequence<op3_ball_detector_msgs/SetParameters_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['op3_ball_detector_msgs', 'srv'], 'SetParameters_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['op3_ball_detector_msgs', 'srv'], 'SetParameters_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from op3_ball_detector_msgs.srv import SetParameters_Request
    ...
    def response(self, value):
        if self._check_fields:
            from op3_ball_detector_msgs.srv import SetParameters_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class SetParameters(metaclass=Metaclass_SetParameters):
    ...
    from op3_ball_detector_msgs.srv._set_parameters import SetParameters_Event as Event
