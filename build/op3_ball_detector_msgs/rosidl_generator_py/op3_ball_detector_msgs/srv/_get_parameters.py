...
class GetParameters_Event(metaclass=Metaclass_GetParameters_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<op3_ball_detector_msgs/GetParameters_Request, 1>',
        'response': 'sequence<op3_ball_detector_msgs/GetParameters_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['op3_ball_detector_msgs', 'srv'], 'GetParameters_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['op3_ball_detector_msgs', 'srv'], 'GetParameters_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from op3_ball_detector_msgs.srv import GetParameters_Request
    ...
    def response(self, value):
        if self._check_fields:
            from op3_ball_detector_msgs.srv import GetParameters_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class GetParameters(metaclass=Metaclass_GetParameters):
    ...
    from op3_ball_detector_msgs.srv._get_parameters import GetParameters_Event as Event
