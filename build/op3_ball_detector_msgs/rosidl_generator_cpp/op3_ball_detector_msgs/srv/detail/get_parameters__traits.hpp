...
[[deprecated("use op3_ball_detector_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const op3_ball_detector_msgs::srv::GetParameters_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  op3_ball_detector_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use op3_ball_detector_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const op3_ball_detector_msgs::srv::GetParameters_Event & msg)
{
  return op3_ball_detector_msgs::srv::to_yaml(msg);
}

template<>
inline const char * data_type<op3_ball_detector_msgs::srv::GetParameters_Event>()
{
  return "op3_ball_detector_msgs::srv::GetParameters_Event";
}

template<>
inline const char * name<op3_ball_detector_msgs::srv::GetParameters_Event>()
{
  return "op3_ball_detector_msgs/srv/GetParameters_Event";
}

template<>
struct has_fixed_size<op3_ball_detector_msgs::srv::GetParameters_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<op3_ball_detector_msgs::srv::GetParameters_Event>
  : std::integral_constant<bool, has_bounded_size<op3_ball_detector_msgs::srv::GetParameters_Request>::value && has_bounded_size<op3_ball_detector_msgs::srv::GetParameters_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<op3_ball_detector_msgs::srv::GetParameters_Event>
  : std::true_type {};
