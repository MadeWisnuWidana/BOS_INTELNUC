...
// IWYU pragma: private, include "robotis_controller_msgs/srv/set_joint_module.h"
...
enum
{
  robotis_controller_msgs__srv__SetJointModule_Event__request__MAX_SIZE = 1
};
// response
enum
{
  robotis_controller_msgs__srv__SetJointModule_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/SetJointModule in the package robotis_controller_msgs.
typedef struct robotis_controller_msgs__srv__SetJointModule_Event
{
  service_msgs__msg__ServiceEventInfo info;
  robotis_controller_msgs__srv__SetJointModule_Request__Sequence request;
  robotis_controller_msgs__srv__SetJointModule_Response__Sequence response;
} robotis_controller_msgs__srv__SetJointModule_Event;

// Struct for a sequence of robotis_controller_msgs__srv__SetJointModule_Event.
typedef struct robotis_controller_msgs__srv__SetJointModule_Event__Sequence
{
