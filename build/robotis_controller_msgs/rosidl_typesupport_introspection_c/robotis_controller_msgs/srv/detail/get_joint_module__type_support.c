...
void robotis_controller_msgs__srv__GetJointModule_Event__rosidl_typesupport_introspection_c__GetJointModule_Event_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  robotis_controller_msgs__srv__GetJointModule_Event__init(message_memory);
}

void robotis_controller_msgs__srv__GetJointModule_Event__rosidl_typesupport_introspection_c__GetJointModule_Event_fini_function(void * message_memory)
{
  robotis_controller_msgs__srv__GetJointModule_Event__fini(message_memory);
}

size_t robotis_controller_msgs__srv__GetJointModule_Event__rosidl_typesupport_introspection_c__size_function__GetJointModule_Event__request(
  const void * untyped_member)
{
  const robotis_controller_msgs__srv__GetJointModule_Request__Sequence * member =
    (const robotis_controller_msgs__srv__GetJointModule_Request__Sequence *)(untyped_member);
  return member->size;
}

const void * robotis_controller_msgs__srv__GetJointModule_Event__rosidl_typesupport_introspection_c__get_const_function__GetJointModule_Event__request(
  const void * untyped_member, size_t index)
{
  const robotis_controller_msgs__srv__GetJointModule_Request__Sequence * member =
    (const robotis_controller_msgs__srv__GetJointModule_Request__Sequence *)(untyped_member);
...
void * robotis_controller_msgs__srv__GetJointModule_Event__rosidl_typesupport_introspection_c__get_function__GetJointModule_Event__request(
  void * untyped_member, size_t index)
{
  robotis_controller_msgs__srv__GetJointModule_Request__Sequence * member =
    (robotis_controller_msgs__srv__GetJointModule_Request__Sequence *)(untyped_member);
  return &member->data[index];
}

void robotis_controller_msgs__srv__GetJointModule_Event__rosidl_typesupport_introspection_c__fetch_function__GetJointModule_Event__request(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const robotis_controller_msgs__srv__GetJointModule_Request * item =
    ((const robotis_controller_msgs__srv__GetJointModule_Request *)
    robotis_controller_msgs__srv__GetJointModule_Event__rosidl_typesupport_introspection_c__get_const_function__GetJointModule_Event__request(untyped_member, index));
  robotis_controller_msgs__srv__GetJointModule_Request * value =
    (robotis_controller_msgs__srv__GetJointModule_Request *)(untyped_value);
  *value = *item;
}

void robotis_controller_msgs__srv__GetJointModule_Event__rosidl_typesupport_introspection_c__assign_function__GetJointModule_Event__request(
  void * untyped_member, size_t index, const void * untyped_value)
{
  robotis_controller_msgs__srv__GetJointModule_Request * item =
    ((robotis_controller_msgs__srv__GetJointModule_Request *)
    robotis_controller_msgs__srv__GetJointModule_Event__rosidl_typesupport_introspection_c__get_function__GetJointModule_Event__request(untyped_member, index));
  const robotis_controller_msgs__srv__GetJointModule_Request * value =
    (const robotis_controller_msgs__srv__GetJointModule_Request *)(untyped_value);
  *item = *value;
}

bool robotis_controller_msgs__srv__GetJointModule_Event__rosidl_typesupport_introspection_c__resize_function__GetJointModule_Event__request(
  void * untyped_member, size_t size)
{
  robotis_controller_msgs__srv__GetJointModule_Request__Sequence * member =
    (robotis_controller_msgs__srv__GetJointModule_Request__Sequence *)(untyped_member);
  robotis_controller_msgs__srv__GetJointModule_Request__Sequence__fini(member);
  return robotis_controller_msgs__srv__GetJointModule_Request__Sequence__init(member, size);
}

size_t robotis_controller_msgs__srv__GetJointModule_Event__rosidl_typesupport_introspection_c__size_function__GetJointModule_Event__response(
  const void * untyped_member)
{
  const robotis_controller_msgs__srv__GetJointModule_Response__Sequence * member =
    (const robotis_controller_msgs__srv__GetJointModule_Response__Sequence *)(untyped_member);
  return member->size;
}

const void * robotis_controller_msgs__srv__GetJointModule_Event__rosidl_typesupport_introspection_c__get_const_function__GetJointModule_Event__response(
  const void * untyped_member, size_t index)
{
  const robotis_controller_msgs__srv__GetJointModule_Response__Sequence * member =
    (const robotis_controller_msgs__srv__GetJointModule_Response__Sequence *)(untyped_member);
...
void * robotis_controller_msgs__srv__GetJointModule_Event__rosidl_typesupport_introspection_c__get_function__GetJointModule_Event__response(
  void * untyped_member, size_t index)
{
  robotis_controller_msgs__srv__GetJointModule_Response__Sequence * member =
    (robotis_controller_msgs__srv__GetJointModule_Response__Sequence *)(untyped_member);
  return &member->data[index];
}

void robotis_controller_msgs__srv__GetJointModule_Event__rosidl_typesupport_introspection_c__fetch_function__GetJointModule_Event__response(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const robotis_controller_msgs__srv__GetJointModule_Response * item =
    ((const robotis_controller_msgs__srv__GetJointModule_Response *)
    robotis_controller_msgs__srv__GetJointModule_Event__rosidl_typesupport_introspection_c__get_const_function__GetJointModule_Event__response(untyped_member, index));
  robotis_controller_msgs__srv__GetJointModule_Response * value =
    (robotis_controller_msgs__srv__GetJointModule_Response *)(untyped_value);
  *value = *item;
}

void robotis_controller_msgs__srv__GetJointModule_Event__rosidl_typesupport_introspection_c__assign_function__GetJointModule_Event__response(
  void * untyped_member, size_t index, const void * untyped_value)
{
  robotis_controller_msgs__srv__GetJointModule_Response * item =
    ((robotis_controller_msgs__srv__GetJointModule_Response *)
    robotis_controller_msgs__srv__GetJointModule_Event__rosidl_typesupport_introspection_c__get_function__GetJointModule_Event__response(untyped_member, index));
  const robotis_controller_msgs__srv__GetJointModule_Response * value =
    (const robotis_controller_msgs__srv__GetJointModule_Response *)(untyped_value);
  *item = *value;
}

bool robotis_controller_msgs__srv__GetJointModule_Event__rosidl_typesupport_introspection_c__resize_function__GetJointModule_Event__response(
  void * untyped_member, size_t size)
{
  robotis_controller_msgs__srv__GetJointModule_Response__Sequence * member =
    (robotis_controller_msgs__srv__GetJointModule_Response__Sequence *)(untyped_member);
  robotis_controller_msgs__srv__GetJointModule_Response__Sequence__fini(member);
  return robotis_controller_msgs__srv__GetJointModule_Response__Sequence__init(member, size);
}

static rosidl_typesupport_introspection_c__MessageMember robotis_controller_msgs__srv__GetJointModule_Event__rosidl_typesupport_introspection_c__GetJointModule_Event_message_member_array[3] = {
  {
    "info",  // name
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(robotis_controller_msgs__srv__GetJointModule_Event, info),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    1,  // array size
    true,  // is upper bound
    offsetof(robotis_controller_msgs__srv__GetJointModule_Event, request),  // bytes offset in struct
    NULL,  // default value
    robotis_controller_msgs__srv__GetJointModule_Event__rosidl_typesupport_introspection_c__size_function__GetJointModule_Event__request,  // size() function pointer
    robotis_controller_msgs__srv__GetJointModule_Event__rosidl_typesupport_introspection_c__get_const_function__GetJointModule_Event__request,  // get_const(index) function pointer
    robotis_controller_msgs__srv__GetJointModule_Event__rosidl_typesupport_introspection_c__get_function__GetJointModule_Event__request,  // get(index) function pointer
    robotis_controller_msgs__srv__GetJointModule_Event__rosidl_typesupport_introspection_c__fetch_function__GetJointModule_Event__request,  // fetch(index, &value) function pointer
    robotis_controller_msgs__srv__GetJointModule_Event__rosidl_typesupport_introspection_c__assign_function__GetJointModule_Event__request,  // assign(index, value) function pointer
    robotis_controller_msgs__srv__GetJointModule_Event__rosidl_typesupport_introspection_c__resize_function__GetJointModule_Event__request  // resize(index) function pointer
  },
  {
    "response",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_MESSAGE,  // type
    ...
    1,  // array size
    true,  // is upper bound
    offsetof(robotis_controller_msgs__srv__GetJointModule_Event, response),  // bytes offset in struct
    NULL,  // default value
    robotis_controller_msgs__srv__GetJointModule_Event__rosidl_typesupport_introspection_c__size_function__GetJointModule_Event__response,  // size() function pointer
    robotis_controller_msgs__srv__GetJointModule_Event__rosidl_typesupport_introspection_c__get_const_function__GetJointModule_Event__response,  // get_const(index) function pointer
    robotis_controller_msgs__srv__GetJointModule_Event__rosidl_typesupport_introspection_c__get_function__GetJointModule_Event__response,  // get(index) function pointer
    robotis_controller_msgs__srv__GetJointModule_Event__rosidl_typesupport_introspection_c__fetch_function__GetJointModule_Event__response,  // fetch(index, &value) function pointer
    robotis_controller_msgs__srv__GetJointModule_Event__rosidl_typesupport_introspection_c__assign_function__GetJointModule_Event__response,  // assign(index, value) function pointer
    robotis_controller_msgs__srv__GetJointModule_Event__rosidl_typesupport_introspection_c__resize_function__GetJointModule_Event__response  // resize(index) function pointer
  }
};

static const rosidl_typesupport_introspection_c__MessageMembers robotis_controller_msgs__srv__GetJointModule_Event__rosidl_typesupport_introspection_c__GetJointModule_Event_message_members = {
  "robotis_controller_msgs__srv",  // message namespace
  "GetJointModule_Event",  // message name
  3,  // number of fields
  sizeof(robotis_controller_msgs__srv__GetJointModule_Event),
  false,  // has_any_key_member_
  robotis_controller_msgs__srv__GetJointModule_Event__rosidl_typesupport_introspection_c__GetJointModule_Event_message_member_array,  // message members
  robotis_controller_msgs__srv__GetJointModule_Event__rosidl_typesupport_introspection_c__GetJointModule_Event_init_function,  // function to initialize message memory (memory has to be allocated)
  robotis_controller_msgs__srv__GetJointModule_Event__rosidl_typesupport_introspection_c__GetJointModule_Event_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t robotis_controller_msgs__srv__GetJointModule_Event__rosidl_typesupport_introspection_c__GetJointModule_Event_message_type_support_handle = {
  0,
  &robotis_controller_msgs__srv__GetJointModule_Event__rosidl_typesupport_introspection_c__GetJointModule_Event_message_members,
  get_message_typesupport_handle_function,
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_robotis_controller_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robotis_controller_msgs, srv, GetJointModule_Event)() {
  robotis_controller_msgs__srv__GetJointModule_Event__rosidl_typesupport_introspection_c__GetJointModule_Event_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, service_msgs, msg, ServiceEventInfo)();
  robotis_controller_msgs__srv__GetJointModule_Event__rosidl_typesupport_introspection_c__GetJointModule_Event_message_member_array[1].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robotis_controller_msgs, srv, GetJointModule_Request)();
  robotis_controller_msgs__srv__GetJointModule_Event__rosidl_typesupport_introspection_c__GetJointModule_Event_message_member_array[2].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robotis_controller_msgs, srv, GetJointModule_Response)();
  if (!robotis_controller_msgs__srv__GetJointModule_Event__rosidl_typesupport_introspection_c__GetJointModule_Event_message_type_support_handle.typesupport_identifier) {
    robotis_controller_msgs__srv__GetJointModule_Event__rosidl_typesupport_introspection_c__GetJointModule_Event_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &robotis_controller_msgs__srv__GetJointModule_Event__rosidl_typesupport_introspection_c__GetJointModule_Event_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
...
static rosidl_service_type_support_t robotis_controller_msgs__srv__detail__get_joint_module__rosidl_typesupport_introspection_c__GetJointModule_service_type_support_handle = {
  ...
  &robotis_controller_msgs__srv__GetJointModule_Request__rosidl_typesupport_introspection_c__GetJointModule_Request_message_type_support_handle,
  &robotis_controller_msgs__srv__GetJointModule_Response__rosidl_typesupport_introspection_c__GetJointModule_Response_message_type_support_handle,
  &robotis_controller_msgs__srv__GetJointModule_Event__rosidl_typesupport_introspection_c__GetJointModule_Event_message_type_support_handle,
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robotis_controller_msgs, srv, GetJointModule_Request)(void);

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robotis_controller_msgs, srv, GetJointModule_Response)(void);

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robotis_controller_msgs, srv, GetJointModule_Event)(void);

ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_robotis_controller_msgs
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robotis_controller_msgs, srv, GetJointModule)(void) {
  ...
  if (!service_members->event_members_) {
    service_members->event_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robotis_controller_msgs, srv, GetJointModule_Event)()->data;
  }
