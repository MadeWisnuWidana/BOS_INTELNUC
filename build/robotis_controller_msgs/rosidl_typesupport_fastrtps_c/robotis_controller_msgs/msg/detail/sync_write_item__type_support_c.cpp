  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const robotis_controller_msgs__msg__SyncWriteItem * ros_message = static_cast<const robotis_controller_msgs__msg__SyncWriteItem *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_robotis_controller_msgs__msg__SyncWriteItem(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  robotis_controller_msgs__msg__SyncWriteItem * ros_message = static_cast<robotis_controller_msgs__msg__SyncWriteItem *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_robotis_controller_msgs__msg__SyncWriteItem(cdr, ros_message);
}
