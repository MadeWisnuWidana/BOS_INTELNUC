...
class Metaclass_GetJointModule_Event(type):
    """Metaclass of message 'GetJointModule_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__get_joint_module__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__get_joint_module__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__get_joint_module__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__get_joint_module__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__get_joint_module__event
...
class GetJointModule_Event(metaclass=Metaclass_GetJointModule_Event):
    """Message class 'GetJointModule_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<robotis_controller_msgs/GetJointModule_Request, 1>',
        'response': 'sequence<robotis_controller_msgs/GetJointModule_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['robotis_controller_msgs', 'srv'], 'GetJointModule_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['robotis_controller_msgs', 'srv'], 'GetJointModule_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from robotis_controller_msgs.srv import GetJointModule_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, GetJointModule_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'GetJointModule_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from robotis_controller_msgs.srv import GetJointModule_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, GetJointModule_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'GetJointModule_Response'"
...
class Metaclass_GetJointModule(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _get_joint_module.Metaclass_GetJointModule_Event._TYPE_SUPPORT is None:
                _get_joint_module.Metaclass_GetJointModule_Event.__import_type_support__()
...
class GetJointModule(metaclass=Metaclass_GetJointModule):
    ...
    from robotis_controller_msgs.srv._get_joint_module import GetJointModule_Event as Event
