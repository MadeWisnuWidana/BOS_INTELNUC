...
inline std::string to_yaml(const SetModule_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use robotis_controller_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const robotis_controller_msgs::srv::SetModule_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  robotis_controller_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use robotis_controller_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const robotis_controller_msgs::srv::SetModule_Event & msg)
{
  return robotis_controller_msgs::srv::to_yaml(msg);
}

template<>
inline const char * data_type<robotis_controller_msgs::srv::SetModule_Event>()
{
  return "robotis_controller_msgs::srv::SetModule_Event";
}

template<>
inline const char * name<robotis_controller_msgs::srv::SetModule_Event>()
{
  return "robotis_controller_msgs/srv/SetModule_Event";
}

template<>
struct has_fixed_size<robotis_controller_msgs::srv::SetModule_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<robotis_controller_msgs::srv::SetModule_Event>
  : std::integral_constant<bool, has_bounded_size<robotis_controller_msgs::srv::SetModule_Request>::value && has_bounded_size<robotis_controller_msgs::srv::SetModule_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<robotis_controller_msgs::srv::SetModule_Event>
  : std::true_type {};
