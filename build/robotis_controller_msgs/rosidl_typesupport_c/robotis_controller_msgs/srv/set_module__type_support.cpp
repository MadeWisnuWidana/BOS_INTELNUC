...
static const _SetModule_Event_type_support_symbol_names_t _SetModule_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robotis_controller_msgs, srv, SetModule_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robotis_controller_msgs, srv, SetModule_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, robotis_controller_msgs, srv, SetModule_Event)() {
  return &::robotis_controller_msgs::srv::rosidl_typesupport_c::SetModule_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t SetModule_service_type_support_handle = {
  ...
  &SetModule_Request_message_type_support_handle,
  &SetModule_Response_message_type_support_handle,
  &SetModule_Event_message_type_support_handle,
