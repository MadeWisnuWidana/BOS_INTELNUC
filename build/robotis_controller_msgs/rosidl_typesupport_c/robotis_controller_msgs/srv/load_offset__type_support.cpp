...
static const _LoadOffset_Event_type_support_symbol_names_t _LoadOffset_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robotis_controller_msgs, srv, LoadOffset_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robotis_controller_msgs, srv, LoadOffset_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, robotis_controller_msgs, srv, LoadOffset_Event)() {
  return &::robotis_controller_msgs::srv::rosidl_typesupport_c::LoadOffset_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t LoadOffset_service_type_support_handle = {
  ...
  &LoadOffset_Request_message_type_support_handle,
  &LoadOffset_Response_message_type_support_handle,
  &LoadOffset_Event_message_type_support_handle,
