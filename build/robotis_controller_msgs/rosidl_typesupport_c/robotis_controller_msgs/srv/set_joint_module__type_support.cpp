...
static const _SetJointModule_Request_type_support_symbol_names_t _SetJointModule_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robotis_controller_msgs, srv, SetJointModule_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robotis_controller_msgs, srv, SetJointModule_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, robotis_controller_msgs, srv, SetJointModule_Request)() {
  return &::robotis_controller_msgs::srv::rosidl_typesupport_c::SetJointModule_Request_message_type_support_handle;
}
...
static const _SetJointModule_Response_type_support_symbol_names_t _SetJointModule_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robotis_controller_msgs, srv, SetJointModule_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robotis_controller_msgs, srv, SetJointModule_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, robotis_controller_msgs, srv, SetJointModule_Response)() {
  return &::robotis_controller_msgs::srv::rosidl_typesupport_c::SetJointModule_Response_message_type_support_handle;
}
...
typedef struct _SetJointModule_Event_type_support_ids_t
{
  const char * typesupport_identifier[2];
} _SetJointModule_Event_type_support_ids_t;

static const _SetJointModule_Event_type_support_ids_t _SetJointModule_Event_message_typesupport_ids = {
  {
    "rosidl_typesupport_fastrtps_c",  // ::rosidl_typesupport_fastrtps_c::typesupport_identifier,
    "rosidl_typesupport_introspection_c",  // ::rosidl_typesupport_introspection_c::typesupport_identifier,
  }
...
typedef struct _SetJointModule_Event_type_support_symbol_names_t
{
  const char * symbol_name[2];
} _SetJointModule_Event_type_support_symbol_names_t;

#define STRINGIFY_(s) #s
#define STRINGIFY(s) STRINGIFY_(s)

static const _SetJointModule_Event_type_support_symbol_names_t _SetJointModule_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robotis_controller_msgs, srv, SetJointModule_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robotis_controller_msgs, srv, SetJointModule_Event)),
  }
};

typedef struct _SetJointModule_Event_type_support_data_t
{
  void * data[2];
} _SetJointModule_Event_type_support_data_t;

static _SetJointModule_Event_type_support_data_t _SetJointModule_Event_message_typesupport_data = {
  {
    0,  // will store the shared library later
    0,  // will store the shared library later
  }
...
static const type_support_map_t _SetJointModule_Event_message_typesupport_map = {
  2,
  "robotis_controller_msgs",
  &_SetJointModule_Event_message_typesupport_ids.typesupport_identifier[0],
  &_SetJointModule_Event_message_typesupport_symbol_names.symbol_name[0],
  &_SetJointModule_Event_message_typesupport_data.data[0],
};

static const rosidl_message_type_support_t SetJointModule_Event_message_type_support_handle = {
  rosidl_typesupport_c__typesupport_identifier,
  reinterpret_cast<const type_support_map_t *>(&_SetJointModule_Event_message_typesupport_map),
  rosidl_typesupport_c__get_message_typesupport_handle_function,
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, robotis_controller_msgs, srv, SetJointModule_Event)() {
  return &::robotis_controller_msgs::srv::rosidl_typesupport_c::SetJointModule_Event_message_type_support_handle;
}
...
static const _SetJointModule_type_support_symbol_names_t _SetJointModule_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robotis_controller_msgs, srv, SetJointModule)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robotis_controller_msgs, srv, SetJointModule)),
  }
};
...
static const rosidl_service_type_support_t SetJointModule_service_type_support_handle = {
  ...
  &SetJointModule_Request_message_type_support_handle,
  &SetJointModule_Response_message_type_support_handle,
  &SetJointModule_Event_message_type_support_handle,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, robotis_controller_msgs, srv, SetJointModule)() {
  return &::robotis_controller_msgs::srv::rosidl_typesupport_c::SetJointModule_service_type_support_handle;
}
