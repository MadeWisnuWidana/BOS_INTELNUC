...
static const _SetJointModule_Event_type_support_symbol_names_t _SetJointModule_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robotis_controller_msgs, srv, SetJointModule_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robotis_controller_msgs, srv, SetJointModule_Event)),
  }
};
...
{
  return &::robotis_controller_msgs::srv::rosidl_typesupport_cpp::SetJointModule_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, robotis_controller_msgs, srv, SetJointModule_Event)() {
  return get_message_type_support_handle<robotis_controller_msgs::srv::SetJointModule_Event>();
}
...
static const rosidl_service_type_support_t SetJointModule_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<robotis_controller_msgs::srv::SetJointModule_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<robotis_controller_msgs::srv::SetJointModule_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<robotis_controller_msgs::srv::SetJointModule_Event>(),
