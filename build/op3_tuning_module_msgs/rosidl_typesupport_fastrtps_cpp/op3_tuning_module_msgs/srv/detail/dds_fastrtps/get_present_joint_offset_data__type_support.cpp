  ...
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: present_data_array
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; i++) {
      op3_tuning_module_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize_key(
        ros_message.present_data_array[i],
        cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: present_data_array
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        op3_tuning_module_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size_key(
        ros_message.present_data_array[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: present_data_array
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        op3_tuning_module_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_key_JointOffsetPositionData(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
// functions for op3_tuning_module_msgs::srv::GetPresentJointOffsetData_Request already declared above

// functions for op3_tuning_module_msgs::srv::GetPresentJointOffsetData_Response already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_op3_tuning_module_msgs
cdr_serialize(
  const op3_tuning_module_msgs::srv::GetPresentJointOffsetData_Event & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: info
  ...
  // Member: request
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; i++) {
      op3_tuning_module_msgs::srv::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  op3_tuning_module_msgs::srv::GetPresentJointOffsetData_Event & ros_message)
{
  // Member: info
  ...
  // Member: request
  {
    ...
    for (size_t i = 0; i < size; i++) {
      op3_tuning_module_msgs::srv::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        op3_tuning_module_msgs::srv::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        op3_tuning_module_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_GetPresentJointOffsetData_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        op3_tuning_module_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_GetPresentJointOffsetData_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = op3_tuning_module_msgs::srv::GetPresentJointOffsetData_Event;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: request
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; i++) {
      op3_tuning_module_msgs::srv::typesupport_fastrtps_cpp::cdr_serialize_key(
        ros_message.request[i],
        cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        op3_tuning_module_msgs::srv::typesupport_fastrtps_cpp::get_serialized_size_key(
        ros_message.request[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        op3_tuning_module_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_key_GetPresentJointOffsetData_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        op3_tuning_module_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_key_GetPresentJointOffsetData_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const op3_tuning_module_msgs::srv::GetPresentJointOffsetData_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<op3_tuning_module_msgs::srv::GetPresentJointOffsetData_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &op3_tuning_module_msgs::srv::typesupport_fastrtps_cpp::_GetPresentJointOffsetData_Event__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, op3_tuning_module_msgs, srv, GetPresentJointOffsetData_Event)() {
  return &op3_tuning_module_msgs::srv::typesupport_fastrtps_cpp::_GetPresentJointOffsetData_Event__handle;
}
...
static const rosidl_service_type_support_t _GetPresentJointOffsetData__handle{
  ...
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<op3_tuning_module_msgs::srv::GetPresentJointOffsetData_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<op3_tuning_module_msgs::srv::GetPresentJointOffsetData_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<op3_tuning_module_msgs::srv::GetPresentJointOffsetData_Event>(),
