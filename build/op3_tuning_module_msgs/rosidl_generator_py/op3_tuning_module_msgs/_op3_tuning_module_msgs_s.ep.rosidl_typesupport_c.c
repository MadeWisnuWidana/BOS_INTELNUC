...
static void * op3_tuning_module_msgs__srv__get_present_joint_offset_data__event__create_ros_message(void)
{
  return op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Event__create();
}

static void op3_tuning_module_msgs__srv__get_present_joint_offset_data__event__destroy_ros_message(void * raw_ros_message)
{
  ...
  op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Event__destroy(ros_message);
}

ROSIDL_GENERATOR_C_IMPORT
bool op3_tuning_module_msgs__srv__get_present_joint_offset_data__event__convert_from_py(PyObject * _pymsg, void * ros_message);
ROSIDL_GENERATOR_C_IMPORT
...
ROSIDL_GENERATOR_C_IMPORT
const rosidl_message_type_support_t *
ROSIDL_GET_MSG_TYPE_SUPPORT(op3_tuning_module_msgs, srv, GetPresentJointOffsetData_Event);
...
_register_msg_type__srv__get_present_joint_offset_data__event(PyObject * pymodule)
{
  ...
  PyObject * pyobject_create_ros_message = NULL;
  pyobject_create_ros_message = PyCapsule_New(
    (void *)&op3_tuning_module_msgs__srv__get_present_joint_offset_data__event__create_ros_message,
    NULL, NULL);
  if (!pyobject_create_ros_message) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  PyObject * pyobject_destroy_ros_message = NULL;
  pyobject_destroy_ros_message = PyCapsule_New(
    (void *)&op3_tuning_module_msgs__srv__get_present_joint_offset_data__event__destroy_ros_message,
    NULL, NULL);
  if (!pyobject_destroy_ros_message) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  PyObject * pyobject_convert_from_py = NULL;
  pyobject_convert_from_py = PyCapsule_New(
    (void *)&op3_tuning_module_msgs__srv__get_present_joint_offset_data__event__convert_from_py,
    NULL, NULL);
  if (!pyobject_convert_from_py) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  PyObject * pyobject_convert_to_py = NULL;
  pyobject_convert_to_py = PyCapsule_New(
    (void *)&op3_tuning_module_msgs__srv__get_present_joint_offset_data__event__convert_to_py,
    NULL, NULL);
  if (!pyobject_convert_to_py) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  PyObject * pyobject_type_support = NULL;
  pyobject_type_support = PyCapsule_New(
    (void *)ROSIDL_GET_MSG_TYPE_SUPPORT(op3_tuning_module_msgs, srv, GetPresentJointOffsetData_Event),
    NULL, NULL);
  if (!pyobject_type_support) {
    // previously added objects will be removed when the module is destroyed
    return -1;
