...
void op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Event__rosidl_typesupport_introspection_c__GetPresentJointOffsetData_Event_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Event__init(message_memory);
}

void op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Event__rosidl_typesupport_introspection_c__GetPresentJointOffsetData_Event_fini_function(void * message_memory)
{
  op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Event__fini(message_memory);
}

size_t op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Event__rosidl_typesupport_introspection_c__size_function__GetPresentJointOffsetData_Event__request(
  const void * untyped_member)
{
  const op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Request__Sequence * member =
    (const op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Request__Sequence *)(untyped_member);
  return member->size;
}

const void * op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Event__rosidl_typesupport_introspection_c__get_const_function__GetPresentJointOffsetData_Event__request(
  const void * untyped_member, size_t index)
{
  const op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Request__Sequence * member =
    (const op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Request__Sequence *)(untyped_member);
...
void * op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Event__rosidl_typesupport_introspection_c__get_function__GetPresentJointOffsetData_Event__request(
  void * untyped_member, size_t index)
{
  op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Request__Sequence * member =
    (op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Request__Sequence *)(untyped_member);
  return &member->data[index];
}

void op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Event__rosidl_typesupport_introspection_c__fetch_function__GetPresentJointOffsetData_Event__request(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Request * item =
    ((const op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Request *)
    op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Event__rosidl_typesupport_introspection_c__get_const_function__GetPresentJointOffsetData_Event__request(untyped_member, index));
  op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Request * value =
    (op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Request *)(untyped_value);
  *value = *item;
}

void op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Event__rosidl_typesupport_introspection_c__assign_function__GetPresentJointOffsetData_Event__request(
  void * untyped_member, size_t index, const void * untyped_value)
{
  op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Request * item =
    ((op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Request *)
    op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Event__rosidl_typesupport_introspection_c__get_function__GetPresentJointOffsetData_Event__request(untyped_member, index));
  const op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Request * value =
    (const op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Request *)(untyped_value);
  *item = *value;
}

bool op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Event__rosidl_typesupport_introspection_c__resize_function__GetPresentJointOffsetData_Event__request(
  void * untyped_member, size_t size)
{
  op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Request__Sequence * member =
    (op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Request__Sequence *)(untyped_member);
  op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Request__Sequence__fini(member);
  return op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Request__Sequence__init(member, size);
}

size_t op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Event__rosidl_typesupport_introspection_c__size_function__GetPresentJointOffsetData_Event__response(
  const void * untyped_member)
{
  const op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Response__Sequence * member =
    (const op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Response__Sequence *)(untyped_member);
  return member->size;
}

const void * op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Event__rosidl_typesupport_introspection_c__get_const_function__GetPresentJointOffsetData_Event__response(
  const void * untyped_member, size_t index)
{
  const op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Response__Sequence * member =
    (const op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Response__Sequence *)(untyped_member);
...
void * op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Event__rosidl_typesupport_introspection_c__get_function__GetPresentJointOffsetData_Event__response(
  void * untyped_member, size_t index)
{
  op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Response__Sequence * member =
    (op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Response__Sequence *)(untyped_member);
  return &member->data[index];
}

void op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Event__rosidl_typesupport_introspection_c__fetch_function__GetPresentJointOffsetData_Event__response(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Response * item =
    ((const op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Response *)
    op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Event__rosidl_typesupport_introspection_c__get_const_function__GetPresentJointOffsetData_Event__response(untyped_member, index));
  op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Response * value =
    (op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Response *)(untyped_value);
  *value = *item;
}

void op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Event__rosidl_typesupport_introspection_c__assign_function__GetPresentJointOffsetData_Event__response(
  void * untyped_member, size_t index, const void * untyped_value)
{
  op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Response * item =
    ((op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Response *)
    op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Event__rosidl_typesupport_introspection_c__get_function__GetPresentJointOffsetData_Event__response(untyped_member, index));
  const op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Response * value =
    (const op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Response *)(untyped_value);
  *item = *value;
}

bool op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Event__rosidl_typesupport_introspection_c__resize_function__GetPresentJointOffsetData_Event__response(
  void * untyped_member, size_t size)
{
  op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Response__Sequence * member =
    (op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Response__Sequence *)(untyped_member);
  op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Response__Sequence__fini(member);
  return op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Response__Sequence__init(member, size);
}

static rosidl_typesupport_introspection_c__MessageMember op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Event__rosidl_typesupport_introspection_c__GetPresentJointOffsetData_Event_message_member_array[3] = {
  {
    "info",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Event, info),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    1,  // array size
    true,  // is upper bound
    offsetof(op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Event, request),  // bytes offset in struct
    NULL,  // default value
    op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Event__rosidl_typesupport_introspection_c__size_function__GetPresentJointOffsetData_Event__request,  // size() function pointer
    op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Event__rosidl_typesupport_introspection_c__get_const_function__GetPresentJointOffsetData_Event__request,  // get_const(index) function pointer
    op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Event__rosidl_typesupport_introspection_c__get_function__GetPresentJointOffsetData_Event__request,  // get(index) function pointer
    op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Event__rosidl_typesupport_introspection_c__fetch_function__GetPresentJointOffsetData_Event__request,  // fetch(index, &value) function pointer
    op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Event__rosidl_typesupport_introspection_c__assign_function__GetPresentJointOffsetData_Event__request,  // assign(index, value) function pointer
    op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Event__rosidl_typesupport_introspection_c__resize_function__GetPresentJointOffsetData_Event__request  // resize(index) function pointer
  },
  {
    "response",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_MESSAGE,  // type
    ...
    1,  // array size
    true,  // is upper bound
    offsetof(op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Event, response),  // bytes offset in struct
    NULL,  // default value
    op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Event__rosidl_typesupport_introspection_c__size_function__GetPresentJointOffsetData_Event__response,  // size() function pointer
    op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Event__rosidl_typesupport_introspection_c__get_const_function__GetPresentJointOffsetData_Event__response,  // get_const(index) function pointer
    op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Event__rosidl_typesupport_introspection_c__get_function__GetPresentJointOffsetData_Event__response,  // get(index) function pointer
    op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Event__rosidl_typesupport_introspection_c__fetch_function__GetPresentJointOffsetData_Event__response,  // fetch(index, &value) function pointer
    op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Event__rosidl_typesupport_introspection_c__assign_function__GetPresentJointOffsetData_Event__response,  // assign(index, value) function pointer
    op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Event__rosidl_typesupport_introspection_c__resize_function__GetPresentJointOffsetData_Event__response  // resize(index) function pointer
  }
};

static const rosidl_typesupport_introspection_c__MessageMembers op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Event__rosidl_typesupport_introspection_c__GetPresentJointOffsetData_Event_message_members = {
  "op3_tuning_module_msgs__srv",  // message namespace
  "GetPresentJointOffsetData_Event",  // message name
  3,  // number of fields
  sizeof(op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Event),
  false,  // has_any_key_member_
  op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Event__rosidl_typesupport_introspection_c__GetPresentJointOffsetData_Event_message_member_array,  // message members
  op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Event__rosidl_typesupport_introspection_c__GetPresentJointOffsetData_Event_init_function,  // function to initialize message memory (memory has to be allocated)
  op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Event__rosidl_typesupport_introspection_c__GetPresentJointOffsetData_Event_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Event__rosidl_typesupport_introspection_c__GetPresentJointOffsetData_Event_message_type_support_handle = {
  0,
  &op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Event__rosidl_typesupport_introspection_c__GetPresentJointOffsetData_Event_message_members,
  get_message_typesupport_handle_function,
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_op3_tuning_module_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, op3_tuning_module_msgs, srv, GetPresentJointOffsetData_Event)() {
  op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Event__rosidl_typesupport_introspection_c__GetPresentJointOffsetData_Event_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, service_msgs, msg, ServiceEventInfo)();
  op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Event__rosidl_typesupport_introspection_c__GetPresentJointOffsetData_Event_message_member_array[1].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, op3_tuning_module_msgs, srv, GetPresentJointOffsetData_Request)();
  op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Event__rosidl_typesupport_introspection_c__GetPresentJointOffsetData_Event_message_member_array[2].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, op3_tuning_module_msgs, srv, GetPresentJointOffsetData_Response)();
  if (!op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Event__rosidl_typesupport_introspection_c__GetPresentJointOffsetData_Event_message_type_support_handle.typesupport_identifier) {
    op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Event__rosidl_typesupport_introspection_c__GetPresentJointOffsetData_Event_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Event__rosidl_typesupport_introspection_c__GetPresentJointOffsetData_Event_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
...
static rosidl_service_type_support_t op3_tuning_module_msgs__srv__detail__get_present_joint_offset_data__rosidl_typesupport_introspection_c__GetPresentJointOffsetData_service_type_support_handle = {
  ...
  &op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Request__rosidl_typesupport_introspection_c__GetPresentJointOffsetData_Request_message_type_support_handle,
  &op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Response__rosidl_typesupport_introspection_c__GetPresentJointOffsetData_Response_message_type_support_handle,
  &op3_tuning_module_msgs__srv__GetPresentJointOffsetData_Event__rosidl_typesupport_introspection_c__GetPresentJointOffsetData_Event_message_type_support_handle,
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, op3_tuning_module_msgs, srv, GetPresentJointOffsetData_Request)(void);

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, op3_tuning_module_msgs, srv, GetPresentJointOffsetData_Response)(void);

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, op3_tuning_module_msgs, srv, GetPresentJointOffsetData_Event)(void);

ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_op3_tuning_module_msgs
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, op3_tuning_module_msgs, srv, GetPresentJointOffsetData)(void) {
  ...
  if (!service_members->event_members_) {
    service_members->event_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, op3_tuning_module_msgs, srv, GetPresentJointOffsetData_Event)()->data;
  }
