  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const op3_tuning_module_msgs__msg__JointTorqueOnOff * ros_message = static_cast<const op3_tuning_module_msgs__msg__JointTorqueOnOff *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_op3_tuning_module_msgs__msg__JointTorqueOnOff(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  op3_tuning_module_msgs__msg__JointTorqueOnOff * ros_message = static_cast<op3_tuning_module_msgs__msg__JointTorqueOnOff *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_op3_tuning_module_msgs__msg__JointTorqueOnOff(cdr, ros_message);
}
