...
bool cdr_serialize_op3_tuning_module_msgs__msg__JointTorqueOnOff(
  const op3_tuning_module_msgs__msg__JointTorqueOnOff * ros_message,
  eprosima::fastcdr::Cdr & cdr);

bool cdr_deserialize_op3_tuning_module_msgs__msg__JointTorqueOnOff(
  eprosima::fastcdr::Cdr & cdr,
  op3_tuning_module_msgs__msg__JointTorqueOnOff * ros_message);
...
bool cdr_serialize_key_op3_tuning_module_msgs__msg__JointTorqueOnOff(
  const op3_tuning_module_msgs__msg__JointTorqueOnOff * ros_message,
  eprosima::fastcdr::Cdr & cdr);

size_t get_serialized_size_key_op3_tuning_module_msgs__msg__JointTorqueOnOff(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_key_op3_tuning_module_msgs__msg__JointTorqueOnOff(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: torque_enable_data
  {
    ...
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_op3_tuning_module_msgs__msg__JointTorqueOnOff(
        &array_ptr[i], cdr);
    }
  }
  ...
  op3_tuning_module_msgs__msg__JointTorqueOnOffArray * ros_message)
{
  // Field name: torque_enable_data
  {
    ...
    auto array_ptr = ros_message->torque_enable_data.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_op3_tuning_module_msgs__msg__JointTorqueOnOff(cdr, &array_ptr[i]);
    }
  }
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: torque_enable_data
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_op3_tuning_module_msgs__msg__JointTorqueOnOff(
        &array_ptr[i], cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: torque_enable_data
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_op3_tuning_module_msgs__msg__JointTorqueOnOff(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: torque_enable_data
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_op3_tuning_module_msgs__msg__JointTorqueOnOff(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const op3_tuning_module_msgs__msg__JointTorqueOnOffArray * ros_message = static_cast<const op3_tuning_module_msgs__msg__JointTorqueOnOffArray *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_op3_tuning_module_msgs__msg__JointTorqueOnOffArray(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  op3_tuning_module_msgs__msg__JointTorqueOnOffArray * ros_message = static_cast<op3_tuning_module_msgs__msg__JointTorqueOnOffArray *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_op3_tuning_module_msgs__msg__JointTorqueOnOffArray(cdr, ros_message);
}
