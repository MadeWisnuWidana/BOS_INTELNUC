...
bool cdr_serialize_op3_offset_tuner_msgs__msg__JointOffsetData(
  const op3_offset_tuner_msgs__msg__JointOffsetData * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_op3_offset_tuner_msgs
bool cdr_deserialize_op3_offset_tuner_msgs__msg__JointOffsetData(
  eprosima::fastcdr::Cdr & cdr,
  op3_offset_tuner_msgs__msg__JointOffsetData * ros_message)
{
  // Field name: joint_name
  {
    std::string tmp;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_op3_offset_tuner_msgs
bool cdr_serialize_key_op3_offset_tuner_msgs__msg__JointOffsetData(
  const op3_offset_tuner_msgs__msg__JointOffsetData * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: joint_name
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_op3_offset_tuner_msgs
size_t get_serialized_size_key_op3_offset_tuner_msgs__msg__JointOffsetData(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _JointOffsetData__ros_msg_type * ros_message = static_cast<const _JointOffsetData__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_op3_offset_tuner_msgs
size_t max_serialized_size_key_op3_offset_tuner_msgs__msg__JointOffsetData(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const op3_offset_tuner_msgs__msg__JointOffsetData * ros_message = static_cast<const op3_offset_tuner_msgs__msg__JointOffsetData *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_op3_offset_tuner_msgs__msg__JointOffsetData(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  op3_offset_tuner_msgs__msg__JointOffsetData * ros_message = static_cast<op3_offset_tuner_msgs__msg__JointOffsetData *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_op3_offset_tuner_msgs__msg__JointOffsetData(cdr, ros_message);
}
